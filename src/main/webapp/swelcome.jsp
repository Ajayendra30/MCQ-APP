...
.menu-option img{width:30px;margin-bottom:6px}
...
.content-section{
	...
	background:url("https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1600") center/cover no-repeat;
}
...
/* ✅ CENTERED TYPEWRITER TEXT (NO BOX) */
.type-center{
	position:relative;
	z-index:2;
	text-align:center;
...
<nav>
  <h2>QuizSphere</h2>
  <ul>
    <li><a href="mcqhome.html">Home</a></li>
...
<main>
	...
	<div class="menu-section">
		...
		<div class="menu-table">
			...
			<div class="menu-option">
				<a href="testsub.jsp">
					<img src="https://cdn-icons-png.flaticon.com/512/1087/1087815.png" alt="Practice Test">
					Practice Test
				</a>
			</div>
			<div class="menu-option">
				<a href="viewmar.jsp?n=<%= name %>">
					<img src="https://cdn-icons-png.flaticon.com/512/1828/1828884.png" alt="View Marks">
					View Marks
				</a>
			</div>
			<div class="menu-option">
				<a href="feedback.jsp">
					<img src="https://cdn-icons-png.flaticon.com/512/3190/3190136.png" alt="Feedback">
					Feedback
				</a>
			</div>
	...
	<!-- ✅ RIGHT CONTENT (centered animated text) -->
