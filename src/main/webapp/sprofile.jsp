...
#profileCard table td{
font-size:16px;
padding:7px 4px;
color:#2c3e50;
}

#profileCard table td b{
color:var(--brand);
}
...
"SELECT COUNT(*),AVG(TSCORE),MAX(TSCORE),MAX(TDATE) FROM mcqres WHERE uname=?");

stats.setString(1,uname);

ResultSet statrs=stats.executeQuery();
...
totalTests=statrs.getInt(1);
avgScore=statrs.getDouble(2);
bestScore=statrs.getInt(3);
lastTest=statrs.getString(4);

}

PreparedStatement subps=con.prepareStatement(
"SELECT COUNT(DISTINCT tsub) FROM mcqres WHERE uname=?");

subps.setString(1,uname);
...
+"<tr><td><b>Total Tests:</b> "+totalTests+"</td></tr>"
+"<tr><td><b>Subjects Attempted:</b> "+subjects+"</td></tr>"
+"<tr><td><b>Average Score:</b> "+String.format("%.2f",avgScore)+"</td></tr>"
+"<tr><td><b>Best Score:</b> "+bestScore+"</td></tr>"
+"<tr><td><b>Last Test:</b> "+(lastTest==null?"-":lastTest)+"</td></tr>"
+"<tr><td><b>Performance Level:</b> "+badge+"</td></tr>"
+"</table>"
+"</div>");
...
<p>Your smart companion for quizzes and learning.</p>
</div>
